...
def extract_text_from_pdf(pdf_file):
    ...
    if str(pdf_file.name).split(".")[-1] == 'pdf':
        ...
        text = orgtext
    elif str(pdf_file.name).split(".")[-1] == 'jpg' or str(pdf_file.name).split(".")[-1] == 'jpeg' or \
            str(pdf_file.name).split(".")[-1] == 'png':
...
def extract_text_from_all_pdf(pdf_files):
    ...
    for pdf in pdf_files:
        ...
        elif str(pdf.name).split(".")[-1] == 'jpg' or str(pdf.name).split(".")[-1] == 'jpeg' or \
                str(pdf.name).split(".")[-1] == 'png':
